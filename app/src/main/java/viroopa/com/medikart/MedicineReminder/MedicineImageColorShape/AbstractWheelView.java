...
public abstract class AbstractWheelView extends AbstractWheel {
    ...
    protected static final int DEF_SELECTION_DIVIDER_ACTIVE_ALPHA = 170;

    protected static final int DEF_SELECTION_DIVIDER_DIMMED_ALPHA = 170;

    protected static final int DEF_ITEM_OFFSET_PERCENT = 10;

    protected static final int DEF_ITEM_PADDING = 2;
