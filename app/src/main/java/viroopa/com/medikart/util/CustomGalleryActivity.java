...
public class CustomGalleryActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.medikart_custom_gallery);
...
//.discCache(new UnlimitedDiscCache(cacheDir))
    ...
    private void init() {
        ...
        adapter = new GalleryAdapter(getApplicationContext(), imageLoader,"G",this);
...
//if (adapter.getSelectedcount() <= 3) { // added by prakash
